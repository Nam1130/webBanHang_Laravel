		...
		<table class="shop_table beta-shopping-cart-table" cellspacing="0">
			<thead>
				<tr>
					...
					<th class="product-status">Miêu tả</th>
			...
			<tbody>
				...
				<tr class="cart_item">
					<td class="product-name">
						<div class="media">
							...
							<div class="media-body">
								<img  src="{!! asset('public/user/image/product/'.$product['item']['image']) !!} "  alt="" width="100px">
					...
					<td class="product-quantity">
						<input type="text" name="quantity" id="quantity" onblur="updateCart({{$product['item']['id']}})" class="form-control" value=" {{$product['qty']}}" min="1" max="" >
					</td>

					<td class="product-subtotal">
						<?php $a = $product['item']['unit_price']*$product['qty'] ?>
						<span class="amount"> <?php echo $a; ?> </span>
					</td>
