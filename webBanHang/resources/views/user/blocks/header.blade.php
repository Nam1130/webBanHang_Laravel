<div id="header">
	...
	<div class="header-body">
		<div class="container beta-relative">
			<div class="pull-left">
				<a href="index.html" id="logo"><img src="{{ asset('public/user/assets/dest/images/logo-cake.png')}} " width="200px" alt=""></a>
			</div>
					...
					<div class="cart">					
						...
						<div class="beta-dropdown cart-body">				
							...
							<div class="cart-item" id="cart-item{{$product['item']['id']}}">			
								<a class="cart-item-delete" href="{{route('user/deleteItemCart',$product['item']['id'])}}" value="{{$product['item']['id']}}" soluong="{{$product['qty']}}"><i class="fa fa-times"></i></a>		
								<div class="media">		
