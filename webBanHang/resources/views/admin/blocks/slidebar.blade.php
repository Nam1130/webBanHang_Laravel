    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="{{route('admin/product/getAdd')}}"><i class="fa fa-circle-o"></i> Thêm sản phẩm</a></li>
          <li><a href="{{route('admin/index')}}"><i class="fa fa-circle-o"></i> Xem sản phẩm</a></li>
        </ul>
      </li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li><a href="#"><i class="fa fa-circle-o"></i> Xem Danh mục</a></li>
        </ul>
      </li>
